...
/**
 * This is the item provider adapter for a {@link de.mdelab.comparch.Impact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImpactItemProvider extends AnnotationItemProvider {
	/**
	...
	protected void addIssuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Impact_issue_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Impact_issue_feature", "_UI_Impact_type"),
						ComparchPackage.Literals.IMPACT__ISSUE, true, false, true, null, null, null));
	}
	...
	protected void addArchitecturalElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Impact_architecturalElement_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Impact_architecturalElement_feature",
								"_UI_Impact_type"),
						ComparchPackage.Literals.IMPACT__ARCHITECTURAL_ELEMENT, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Impact_type")
